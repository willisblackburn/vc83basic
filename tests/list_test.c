...
void test_list_directive(void) {
    ...
    const char line_data_3[] = { 'X' | NT_STOP, TOKEN_NO_VALUE, TOKEN_NUM, 0x10, 0x10, TOKEN_NO_VALUE };
    ...
    const char line_data_7[] = { TOKEN_PAREN, 'X' | NT_STOP, TOKEN_OP | OP_ADD, TOKEN_NUM, 0x03, 0x00, TOKEN_NO_VALUE,
        TOKEN_OP | OP_MUL, 'Y' | NT_STOP, TOKEN_NO_VALUE };
    ...
    const char line_data_11[] = { 'X' | NT_STOP, TOKEN_OP | OP_LE, TOKEN_NUM, 0x07, 0x00, TOKEN_OP | OP_OR,
        'Y' | NT_STOP, TOKEN_OP | OP_EQ, TOKEN_NUM, 0x10, 0x10, TOKEN_NO_VALUE };
    const char line_data_12[] = { TOKEN_PAREN, 'X' | NT_STOP, TOKEN_OP | OP_ADD, TOKEN_NUM, 0x03, 0x00, TOKEN_NO_VALUE,
        TOKEN_OP | OP_AND, 'Y' | NT_STOP, TOKEN_NO_VALUE };
    const char line_data_13[] = { TOKEN_UNARY_OP | UNARY_OP_NOT, TOKEN_PAREN, 'X' | NT_STOP, TOKEN_OP | OP_EQ,
        ...
        'Y' | NT_STOP, TOKEN_NO_VALUE, TOKEN_NO_VALUE };
...
void test_list_statment(void) {
    ...
    const char line_data_2[] = { ST_LET, 'X' | NT_STOP, TOKEN_NUM, 0xFF, 0x7F, TOKEN_NO_VALUE };
    ...
    const char line_data_7[] = { ST_ON_GOTO, 'X' | NT_STOP, TOKEN_NO_VALUE, TOKEN_NUM, 0x0A, 0x00, TOKEN_NUM, 0x14, 0x00, TOKEN_NO_VALUE };
