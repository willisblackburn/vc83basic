...
void test_grow(void) {
    ...
    ASSERT_PTR_EQ(line_ptr, program_ptr);
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)line_ptr + sizeof (Line) * 3);
    ASSERT_EQ(*variable_name_table_ptr, 0);
...
void test_shrink(void) {
    ...
    ASSERT_PTR_EQ(line_ptr, program_ptr);
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)line_ptr + sizeof (Line) + 0x400);
    ...
    ASSERT_EQ(err, 0);
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)line_ptr + sizeof (Line) + 0x400 - 0x10);
