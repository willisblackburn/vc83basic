...
void test_initalize_program(void) {
    ...
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)program_ptr + sizeof (Line));
...
void test_advance_next_line_ptr(void) {
    ...
    // Calling advance_next_line_ptr on the empty program should not advance next_line_ptr.
    initialize_program();
    reset_next_line_ptr();
...
void test_grow(void) {
    ...
    ASSERT_PTR_EQ(next_line_ptr, program_ptr);
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)next_line_ptr + sizeof (Line) * 3);
    ASSERT_EQ(*variable_name_table_ptr, 0);
    ASSERT_PTR_EQ(array_name_table_ptr, variable_name_table_ptr + 1);
    ASSERT_EQ(*array_name_table_ptr, 0);
    ASSERT_PTR_EQ(free_ptr, array_name_table_ptr + 1);
    ...
    ASSERT_EQ(next_line_ptr->next_line_offset, sizeof (Line));
...
void test_shrink(void) {
    ...
    ASSERT_PTR_EQ(next_line_ptr, program_ptr);
    ASSERT_PTR_EQ(variable_name_table_ptr, (char*)next_line_ptr + sizeof (Line) + 0x400);
