...
; It's possible the LIST is being called from within the program, so we save the existing line_ptr value
...
@pop_state:
        plstaa  name_ptr                ; Recover values previously saved on stack
        rts
