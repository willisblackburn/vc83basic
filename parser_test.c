...
static void test_parse_multiple_arguments(void) {
    ...
    const char line_data_1[] = { TOKEN_NUM, 0x01, 0x00, TOKEN_NO_VALUE };
    const char line_data_2[] = { TOKEN_NUM, 0x01, 0x00, TOKEN_NO_VALUE, TOKEN_NUM, 0x00, 0x01, TOKEN_NO_VALUE };
    const char line_data_3[] = { 0x80, TOKEN_NO_VALUE, 0x81, TOKEN_NO_VALUE, TOKEN_NUM, 0x40, 0x00, TOKEN_NO_VALUE };
    const char line_data_4[] = { TOKEN_NUM, 0x01, 0x00, TOKEN_NO_VALUE, TOKEN_NO_VALUE };
